...
public class youtube_player extends WebView
{
    private int frameHeight;
    public static boolean isPlaying=false;
    public boolean isAudioVideoBlock=false;
    public boolean isVideoBlock=false;
    private youtube_player.OnStateChangeListener cbstate;
    private youtube_player.OnReadyListener cbready;
    ...
    private youtube_player.OnReceivedData cbrecvdata;
    private youtube_player.OnPlayerProgressListener cbprog;
    private youtube_player.OnErrorListener cberr;
    private youtube_player.OnVideoURLReadyListener cbvidurl;
    ...
    public youtube_player(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        initView();
    }
    public youtube_player(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public youtube_player(Context context) {
        super(context);
        initView();
    }
    @Override
